...
sys.path.insert(0, os.path.join(base, 'tests', 'gestionTemps'))

from gestionTemps import decompositionDate, decompositionDateComplete, checkBissextile, checkJour, checkHeure, checkMinute, calculTemps, formatDateHeure
